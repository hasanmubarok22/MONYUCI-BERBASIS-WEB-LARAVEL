      ...
      <div class="row">
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <div class="row g-3">
              <a href="{{route('laundry.profile')}}" class="card border-0 shadow col-md-12" style="text-decoration: none;">
                <div class="card-body d-flex justify-content-between">
                  <h6 class="card-text mb-0">Profil Saya</h6>
                  <i class="fas fa-chevron-right"></i>
                </div>
              </a>
              <a href="{{route('laundry.address')}}" class="card border-0 shadow col-md-12" style="text-decoration: none;">
                <div class="card-body d-flex justify-content-between">
